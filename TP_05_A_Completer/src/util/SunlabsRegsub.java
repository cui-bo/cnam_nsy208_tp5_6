 ...
 * Last modified by cstevens on 99/10/14 13:11:16
 */
...
public class SunlabsRegsub
{
     ...
     *
     * @see	SunlabsRegexp#sub
     * @see	SunlabsRegexp#subAll
     */
    public
    SunlabsRegsub(SunlabsRegexp r, String str)
    {
	this.r = r;
	this.str = str;
	this.ustart = 0;
